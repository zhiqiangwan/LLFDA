...
#         return source_GP_mean
    ...
    pool1_domain_shift = calculate_domain_shift(pool1, batch_size, 'pool1_domain_shift')
    predicted_output.append(pool1_domain_shift)
    ...
    pool2_domain_shift = calculate_domain_shift(pool2, batch_size, 'pool2_domain_shift')
    predicted_output.append(pool2_domain_shift)
    ...
    conv4_3_norm_domain_shift = calculate_domain_shift(conv4_3_norm, batch_size, 'conv4_3_norm_domain_shift')
    predicted_output.append(conv4_3_norm_domain_shift)

    fc7_domain_shift = calculate_domain_shift(fc7, batch_size, 'fc7_domain_shift')
    predicted_output.append(fc7_domain_shift)

    conv6_2_domain_shift = calculate_domain_shift(conv6_2, batch_size, 'conv6_2_domain_shift')
    predicted_output.append(conv6_2_domain_shift)

    conv7_2_domain_shift = calculate_domain_shift(conv7_2, batch_size, 'conv7_2_domain_shift')
    predicted_output.append(conv7_2_domain_shift)

    conv8_2_domain_shift = calculate_domain_shift(conv8_2, batch_size, 'conv8_2_domain_shift')
    predicted_output.append(conv8_2_domain_shift)

    conv9_2_domain_shift = calculate_domain_shift(conv9_2, batch_size, 'conv9_2_domain_shift')
    predicted_output.append(conv9_2_domain_shift)

    conv10_2_domain_shift = calculate_domain_shift(conv10_2, batch_size, 'conv10_2_domain_shift')
    predicted_output.append(conv10_2_domain_shift)
