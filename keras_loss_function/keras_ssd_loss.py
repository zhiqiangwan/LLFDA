...
class SSDLoss:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        During training (Model.fit or Model.fit_generator), this function will be called.
        In this function, y_true is the labels directly from the training data or from generator.
        y_pred is the output of our model. Since y_pred is the predicted class and offset of each anchor boxes,
        y_true should also be encoded into the same formate (class and offset of each anchor boxes.)
        ...
        # The Smooth L1 loss is used for doing box regression on some object detection systems, (SSD,Fast/Faster RCNN)
        # according to those papers this loss is less sensitive to outliers, than other regression loss, like L2 which is used on R-CNN and SPPNet.
        ...
        negatives = y_true[:,:,0] # 0 indicates class 0 (background). Tensor of shape (batch_size, n_boxes)
